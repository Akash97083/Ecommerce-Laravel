					...
					<div class="row">
                        <div class="col-lg-3">
                            <div class="nav flex-column m-3 nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link" data-toggle="pill" href="#rocket">{{ __('Rocket') }}</a>
							...
							<div class="p-5">
								<div class="admin-form">
                                    ...
                                    <div class="container pl-0 pr-0 ml-0 mr-0 w-100 mw-100">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $bkash->status == 1 ? '' : 'd-none' }}">
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $bkash->photo ? asset('assets/images/'.$bkash->photo) : asset('assets/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                        ...
                                        <div id="rocket" class="container tab-pane"><br>
                                            <div class="row justify-content-center">
                                                <div class="col-lg-8">
                                                    <form action="{{ route('back.setting.payment.update') }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="switch-primary">
                                                            <input type="checkbox" class="switch switch-bootstrap " name="status" value="1" {{ $rocket->status == 1 ? 'checked' : '' }}>
                                                            <span class="switch-body"></span>
                                                            <span class="switch-text">{{ __('Display Rocket') }}</span>
                                                        </label>
                                                    </div>
                                                    <div class="image-show {{ $rocket->status == 1 ? '' : 'd-none' }}">
                                                        <div class="form-group col-xl-12">
                                                            <label for="name">{{ __('Current Image') }}</label>
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $rocket->photo ? asset('assets/images/'.$rocket->photo) : asset('assets/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="text" id="text" class="form-control text-editor" rows="5"
                                                                placeholder="{{ __('Enter Text') }}"
                                                                >{{ $rocket->text }}</textarea>
                                                        </div>

                                                        <input type="hidden" name="unique_keyword" value="rocket">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $nagad->status == 1 ? '' : 'd-none' }}">
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $nagad->photo ? asset('assets/images/'.$nagad->photo) : asset('assets/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
