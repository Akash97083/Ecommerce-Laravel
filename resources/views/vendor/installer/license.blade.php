            ...
            <div>
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    <label for="purchase_code">
                        Purchase Code | <?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> 
                    </label>
                    <input type="text" name="purchase_code" id="purchase_code" value="NullJungle" placeholder="random value" />
