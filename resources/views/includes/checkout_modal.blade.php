...
@endsection
  ...
  <div class="modal fade" id="bkash" tabindex="-1"  aria-hidden="true">
     ...
     <!-- Modal rocket -->
  <div class="modal fade" id="rocket" tabindex="-1"  aria-hidden="true">
      <div class="modal-dialog" >
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title">{{ __('Transactions via Rocket') }}</h6>
            <button class="close" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </div>
          <form action="{{route('front.checkout.submit')}}" method="POST">
          <div class="modal-body">
            ...
            <p>{!!PriceHelper::GatewayText('rocket')!!}</p>
          </div>
          <div class="modal-footer">
              ...
              <input type="hidden" name="state_id" value="" class="state_id_setup">
            <button class="btn btn-primary btn-sm" type="button" data-bs-dismiss="modal">{{ __('Cancel') }}</button>
            <button class="btn btn-primary btn-sm" type="submit"><span>{{ __('Checkout With Rocket') }}</span></button>
          </form>
          </div>
        </div>
      </div>
